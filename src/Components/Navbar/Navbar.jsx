    ...
    return (
        <header className='text-gray-900 shadow-sm'>
            <div className='mx-auto flex flex-wrap py-5 px-20 flex-col md:flex-row items-center'>
                <Link to="/" className=''>
                    <span className='ml-3 text-2xl font-medium items-center text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-lime-500 mb-4 md:mb-0'>House Hunter</span>
                </Link>
                    ...
                    user ? (
                        ...
                        <div className='relative inline-block'>
                            ...
                            {isDropdownOpen && (
                              ...
                              <Link onClick={()=> setIsDropDownOpen(!isDropdownOpen)} to="/dashboard" className='flex items-center px-3 py-3 text-sm text-gray-700 capitalize transition-colors duration-200 transform hover:bg-gray-100'>
                                                <svg
